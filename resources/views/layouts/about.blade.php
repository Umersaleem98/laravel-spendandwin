      ...
      <div class="col-md-4">
        <div class="card shadow-sm h-100">
          <div class="card-body">
            ...
            <p class="card-text">Invest and get a chance to win exciting rewards. Winner will be announced after 24 hours.</p>
            <ul class="list-unstyled">
              <li><strong>Minimum Investment:</strong> Rs. 10</li>
              <li><strong>Deadline:</strong> {{ \Carbon\Carbon::now()->addHours(24)->format('d M Y, h:i A') }}</li>
            </ul>
      ...
      <div class="col-md-4">
        <div class="card shadow-sm h-100 border-success">
          <div class="card-body">
            ...
            <ul class="list-unstyled">
              <li><strong>1st Prize:</strong> Ali Khan (Rs. 10,000)</li>
              <li><strong>2nd Prize:</strong> Sara Ahmed (Rs. 5,000)</li>
              <li><strong>3rd Prize:</strong> Bilal Zafar (Rs. 2,000)</li>
