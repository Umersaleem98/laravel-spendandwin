    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="row g-1">
                    <div class="col-4">
                        <img class="img-fluid" src="templates/img/service-1.jpg" alt="">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid" src="templates/img/service-2.jpg" alt="">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid" src="templates/img/service-3.jpg" alt="">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid" src="templates/img/service-4.jpg" alt="">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid" src="templates/img/service-5.jpg" alt="">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid" src="templates/img/service-6.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
